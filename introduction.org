...
- The slides only contain a summary:  details in the reference books.
**** Homework/class activities: (40% of grade)
- Class activities, quizzes, etc.
- Home Assignments are obligatory.
- In English or French.
- Can be individual or group.
- You *must cite sources* (books, web pages, students, LLMs, etc)
- It's *OK* if you make mistakes or do not understand something. In the latter case, explain what the difficulty is.

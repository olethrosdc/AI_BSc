...
|        |                                  |                                            |
|--------+----------------------------------+--------------------------------------------|
|      5 | Logical reasoning                | 6.1. States, Actions, Goals                |
|        | Deterministic planning           | 6.2. Forward Planning                      |
...
|--------+----------------------------------+--------------------------------------------|
|      7 | Expected Utility Theory          | 12.1 Preferences and Utility               |
|        |                                  | 12.2 One-off decisions                     |
|--------+----------------------------------+--------------------------------------------|
|      8 | Markov Decision Processes        | 12.3 Sequential Decisions                  |
|        | Dynamic Programming              | 12.4 The value of information              |
|        |                                  | 12.5 Decision processes                    |
|--------+----------------------------------+--------------------------------------------|
|      9 | Alternating Zero-Sum Games       | 14.1. Multi-agent framework                |
|        | Stochastic Zero-Sum Games        | 14.2. Representations of games             |
|        |                                  | 14.3. Perfect information games            |
|--------+----------------------------------+--------------------------------------------|
|     10 | Simultaneous Move Zero-Sum Games | 14.4. Reasoning with imperfect information |
|        | Linear Programming               | 14.5. Group decision making                |
|        | General games                    | 14.6. Mechanism design                     |
|--------+----------------------------------+--------------------------------------------|
|     11 | Learning from data               | 7.1. Learning Issues                       |
|        | Loss functions                   | 7.2. Supervised Learning                   |
|        | The perceptron algorithm         | 7.3. Basic SL models                       |
|        | Stochastic gradient              | 8.1. Overfitting                           |
|        | Oferfittin                       | 8,2, Optimization                          |
|--------+----------------------------------+--------------------------------------------|

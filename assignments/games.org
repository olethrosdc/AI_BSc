...
- Find dominated actions for either player
- Is there a pure Nash equilibrium in the remaining actions?

** Solution

Action 1 is dominated for P1
Action 1 is dominated for P2.
So we can just look at this sub-matrix.
...
- If a=(2,2) is played, then P1 prefers a=(3,2). Not Nash.
- If a=(3,2) is played, then P2 prefers a=(3,3). Not Nash.
- If a=(3,3) is played, then P1 prefers a=(2,3). Not Nash.
- If a=(2,3) is played, then P2 prefers a=(-1,2). Not Nash.

Hence, the NE is a mixed strategy where both players play 2, 3 with some >0 probability.

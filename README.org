...
5. Advanced coding aids: Specify what you used, including generative-AI. Say where you used it exactly, so we can filter it out.
...
|        |                            |                                 |                                    |   |
|--------+----------------------------+---------------------------------+------------------------------------+---|
|      6 | Uncertainty                | 9. Reasoning with Uncertainty   | 12.1. Acting under uncertainty     |   |
...
|----+-----------------------------------------------------------------------------------------------------------------------------|
|  5 | 9.1 Probability, Independence, Belief Networks                                                                              |
|    |                                                                                                                             |
...
|----+-----------------------------------------------------------------------------------------------------------------------------|
|  6 | Independence, Conditional Independence                                                                                      |
|    | Graphical models                                                                                                            |
|    |                                                                                                                             |
|    | Assignment:                                                                                                                 |
|    | - Graphical model of their project problem                                                                                  |
|----+-----------------------------------------------------------------------------------------------------------------------------|
|  7 | 12.1. Preferences and Utility. 12.2 Probability. Decision making.                                                           |
|    |                                                                                                                             |
...
** Conditional probability: The cards problem
 1. We have cards which are [A|A], [A|B] or [B|B] on their sides.
...
| Open | Hidden | Prior |            |     |
|------+--------+-------+------------+-----|
| R    | R      | 1/4   | R observed | 1/2 |
| R    | B      | 1/4   | R observed | 1/2 |
| B    | R      | 1/4   |            |     |
| B    | B      | 1/4   |            |     |
